  ...
  return (
    <div className="bg-[#222629]">
      <div className="container mx-auto max-w-7xl px-6 flex-grow pt-16 pb-16">
        ...
        <p className="text-justify font-normal text-xs md:text-xl leading-relaxed text-[#C0C0C0]">
          ...
          personal information with third parties. All transactions and
          personal data are safeguarded with end-to-end encryption and
